					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"gridwidth": 1170, "gridheight": 325}'>
						<ul>
							<li data-transition="fade">
								...
								<img src="{{ asset('porto/img/custom-header-bg.png')}}"  
									alt=""
								...
								<div class="tp-caption top-label"
									...
									data-y="80"
									data-start="500"
									data-transform_in="y:[-300%];opacity:0;s:500;">Trabaja con Nosotros</div>
								...
								<div class="tp-caption main-label"
									...
									data-mask_in="x:0px;y:0px;">Únete a AXION TI</div>

								<div class="tp-caption bottom-label"
									data-x="185"
									data-y="180"
									data-start="2000"
									data-transform_in="y:[100%];opacity:0;s:500;">y avancemos juntos...</div>
