...
<div class="body">
						...
						<div class="header-row">
							<div class="header-column">
								<div class="header-logo">
									<a href="index.html">
										<img alt="Porto" width="111" height="54" data-sticky-width="82" data-sticky-height="40" data-sticky-top="33" src="porto/img/logo.png">
									</a>
								</div>
							</div>
							<div class="header-column">
												...
												<ul class="nav nav-pills" id="mainNav">
													<li class="dropdown active">
														...
														<ul class="dropdown-menu">
															<li><a href="index-classic.html">Default Home</a></li>
			...
			<div role="main" class="main" id="home">
					...
					<div id="revolutionSlider" class="slider rev_slider" data-plugin-revolution-slider data-plugin-options='{"sliderLayout":"fullscreen", "fullScreenOffsetContainer": "#header", "fullScreenOffset": "0"}'>
						<ul>
							<li data-transition="fade">
								<img src="porto/img/slides/ingeniero_original.jpg"  
									alt=""
								...
								<div class="tp-caption"
									...
									data-start="1000"
									style="z-index: 5"
									data-transform_in="x:[-300%];opacity:0;s:500;"><img src="porto/img/slides/slide-title-border.png" alt=""></div>
							...
							<li data-transition="fade">
								<img src="porto/img/slides/servidores_original.jpeg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
							...
							<li data-transition="fade">
								<img src="porto/video/Kaseya_thumb.png"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat" 
								...
								<div class="rs-background-video-layer" 
									...
									data-videomp4="porto/video/Kaseya.mp4" 
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div id="popupProject" class="popup-inline-content">
									...
									<div class="row">
										<div class="col-md-5">
											<img class="img-thumbnail img-responsive mb-lg" alt="" src="porto/img/projects/project.jpg">
										</div>
								...
								<div class="owl-carousel owl-theme mb-none" data-plugin-options='{"items": 4, "margin": 20, "loop": false}'>
										...
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project.jpg" class="img-responsive" alt="">
									...
									<div>
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project-1.jpg" class="img-responsive" alt="">
													<span class="thumb-info-title">
									...
									<div>
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project-2.jpg" class="img-responsive" alt="">
													<span class="thumb-info-title">
									...
									<div>
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project-3.jpg" class="img-responsive" alt="">
													<span class="thumb-info-title">
									...
									<div>
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project-4.jpg" class="img-responsive" alt="">
													<span class="thumb-info-title">
									...
									<div>
										<a href="#popupProject" data-plugin-lightbox data-plugin-options='{"type": "inline", preloader: false}'>
											<span class="thumb-info">
												<span class="thumb-info-wrapper">
													<img src="porto/img/projects/project-5.jpg" class="img-responsive" alt="">
													<span class="thumb-info-title">
				...
				<section class="parallax section section-text-light section-parallax section-center" data-stellar-background-ratio="0.5" style="background-image: url(porto/img/parallax.jpg);">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
				...
				<section class="parallax section section-parallax section-center mb-none" data-stellar-background-ratio="0.5" style="background-image: url(porto/img/parallax-transparent.jpg);">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-1">
								<a href="index.html" class="logo">
									<img alt="Porto Website Template" class="img-responsive" src="porto/img/logo-footer.png">
								</a>
							</div>
							<div class="col-md-11">
