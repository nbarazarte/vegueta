...
<div class="row">
	...
	<div class="col-md-4 col-md-offset-1 mt-xl">
		...
		<img class="img-responsive mt-xl appear-animation" src="{{ asset('porto/img/outsourcing.png') }}" alt="" data-appear-animation="fadeInLeft">
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-eye" aria-hidden="true"></i> Axion Desk</h3>
		</div>
	...
	<div class="col-md-4">
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-eye" aria-hidden="true"></i> Axion Monitor</h3>
		</div>
	...
	<div class="col-md-4">
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-hdd-o" aria-hidden="true"></i> Axion Backup</h3>
		</div>
...
<div class="row">
	...
	<div class="col-md-4">
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-shield" aria-hidden="true"></i> Axion Security</h3>
		</div>
	...
	<div class="col-md-4">
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-building" aria-hidden="true"></i> Axion Company</h3>
		</div>
	...
	<div class="col-md-4">
		<div class="heading-title heading-border-bottom heading-color text-center">
			<h3 style="color: #00a69c"> <i class="fa fa-id-badge" aria-hidden="true"></i> Axion Talents</h3>
		</div>
